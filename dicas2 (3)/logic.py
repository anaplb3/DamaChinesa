...
def pecaDoJogador(numJogadores):
  ...
  if numJogadores == 2:
    ...
    pecas = ['\033[31m'+'R'+'\033[0;0m', '\033[34m'+'B'+'\033[0;0m', '\033[32m'+'A'+'\033[0;0m']
  elif numJogadores == 4:
    pecas = ['\033[35m'+'N'+'\033[0;0m', '\033[33m'+'C'+'\033[0;0m', '\033[34m'+'B'+'\033[0;0m', '\033[32m'+'A'+'\033[0;0m']
  else:
    pecas = ['\033[31m'+'R'+'\033[0;0m', '\033[35m'+'N'+'\033[0;0m', '\033[33m'+'C'+'\033[0;0m', '\033[34m'+'B'+'\033[0;0m', '\033[32m'+'A'+'\033[0;0m', '\033[37m'+'V'+'\033[0;0m']
  return pecas
...
def parteTres(tabuleiro):
     ...
     for linha in range(8,13,1):
          for coluna in range(9, colunas): 
               tabuleiro[linha][coluna] = '\033[32m'+'A'+'\033[0;0m'
          colunas += 1
